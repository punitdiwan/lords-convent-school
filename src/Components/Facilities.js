          ...
          <div className="facilitycontent">
            ...
            <div className="facilitCard">
              ...
              <div className="facontent">
                <div className="factitle">Nursary to Class 8</div>
                <p>Nursary classrooms are equipped with age-appropriate furniture, colorful educational materials, and sensory tools that encourage play-based learning, creativity, and social interaction. The school often includes dedicated spaces for subjects like science, art, and computer studies, ensuring that students in Classes 1 to 8 have access to a broad and balanced curriculum. Additionally, these students benefit from a variety of recreational spaces, including playgrounds, sports facilities, and art corners, allowing them to explore extracurricular interests alongside their academic pursuits.</p>
              </div>
            </div>
