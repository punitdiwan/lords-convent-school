        ...
        <div id="carouselExampleIndicators" className="carousel slide" data-ride="carousel">
          ...
          <div className="carousel-inner" role="listbox">
            <div className="carousel-item active">
              <img className="d-block slideimage" src="./images1/lords convent slider.jpg" alt="First slide" />
            ...
            <div className="carousel-item">
              <img className="d-block slideimage" src="./images1/lords convent slider.jpg" alt="Second slide" />
              {/*    <div className="carousel-caption d-none d-md-block">
            ...
            <div className="carousel-item">
              <img className="d-block slideimage" src="./images1/lords convent slider.jpg" alt="Third slide" />
              {/*  <div className="carousel-caption d-none d-md-block">
            ...
            <div className="carousel-item">
              <img className="d-block slideimage" src="./images1/lords convent slider.jpg" alt="Fourt slide" />
              {/*  <div className="carousel-caption d-none d-md-block">
            ...
            <div className="carousel-item">
              <img className="d-block slideimage" src="./images1/lords convent slider.jpg" alt="Fifth slide" />
              {/*   <div className="carousel-caption d-none d-md-block">
